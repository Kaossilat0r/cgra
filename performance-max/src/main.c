...
#define COL_JUMP 192			// (WIDTH * KERNEL_SIZE)

#define COL_BLOCK_1_START 0 	// 0
#define COL_BLOCK_1_END 24		// (COL_BLOCK_1_START + WIDTH)

#define COL_BLOCK_2_START 192 	// COL_JUMP
#define COL_BLOCK_2_END 216		//(COL_BLOCK_2_START + WIDTH)

#define COL_BLOCK_3_START 384	// (COL_JUMP * 2)
#define COL_BLOCK_3_END 408		// (COL_BLOCK_3_START + WIDTH)
...
inline void calculateCol(int* array) {
...
inline void reverseCol(int* array) {
	int a0 = array[0];
	int a1 = array[PITCH];	
